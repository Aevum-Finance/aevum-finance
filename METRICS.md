...
_Generated 2026-08-12 · backend @ 9d7ee1c7 · frontend @ 91d8b6c4._
...
| Tests | 1,482 | 924 |
| Code lines (ex. blanks/comments) | 47,972 | 73,613 |

## Backend — API & domain engine

- **25 feature modules** · 56 data models · 154 REST endpoints (33 routers) · 8 scheduled workers
- **1,482 tests** (pytest) · complexity avg A (2.67) · maintainability grade A on 99.3% of modules
- **47,972 SLOC** (27,087 app / 20,885 tests)
